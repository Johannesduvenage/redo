...
config.watch = {
  ...
  tickrate: 20
 // tickrate: 500 //Was ok with BNBBTC
  //tickrate: 60
}
...
config.tradingAdvisor = {
  enabled: true,
  method: 'Alain1',
  //candleSize: 60, //1 hour
  candleSize: 1, //1 minute
  //candleSize: 10, //10 minute was ok with BNBBTC and tickrate = 500
  historySize: 0,
}
...
config.paperTrader = {
  ...
  simulationBalance: {
    ...
    asset: 1,
    //asset: 630, //630 STORJ for about 0.05 BTC
    currency: 100,
  },
...
// Setting for Alain's strategy
config.Alain1 = {

  PERCENTAGE_PRICE_DOWN_BEFORE_MONITORING: 0.98, //Down trend before to look for the up trend to buy
  PERCENTAGE_TRAILING_BUY: 1.02, //MOve up before to BUY
  PERCENTAGE_STOPLOSS: 0.9,
  PERCENTAGE_TAKE_PROFIT: 1.10,
  PERCENTAGE_TRAILING_TP: 0.95  
